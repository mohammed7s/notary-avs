...
func AbiEncodeTaskResponse(h *cstaskmanager.INotaryTaskManagerTaskResponse) ([]byte, error) {
...
func GetTaskResponseDigest(h *cstaskmanager.INotaryTaskManagerTaskResponse) ([32]byte, error) {
