...
import (
	...
	csservicemanager "github.com/Layr-Labs/incredible-squaring-avs/contracts/bindings/NotaryServiceManager"
	cstaskmanager "github.com/Layr-Labs/incredible-squaring-avs/contracts/bindings/NotaryTaskManager"
)

type AvsManagersBindings struct {
	TaskManager    *cstaskmanager.ContractNotaryTaskManager
	ServiceManager *csservicemanager.ContractNotaryServiceManager
...
func NewAvsManagersBindings(registryCoordinatorAddr, operatorStateRetrieverAddr gethcommon.Address, ethclient eth.EthClient, logger logging.Logger) (*AvsManagersBindings, error) {
	...
	contractServiceManager, err := csservicemanager.NewContractNotaryServiceManager(serviceManagerAddr, ethclient)
	if err != nil {
	...
	contractTaskManager, err := cstaskmanager.NewContractNotaryTaskManager(taskManagerAddr, ethclient)
	if err != nil {
